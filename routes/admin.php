...
//        Route::post('weboption/store', 'WebOptionController@store')->name('admin.weboption.store')->middleware('permission:config.weboption.create');
        //编辑
        Route::get('weboption/{weboption}/edit', 'WebOptionController@edit')->name('admin.weboption.edit')->middleware('permission:config.weboption.edit');
        Route::put('weboption/{weboption}/update', 'WebOptionController@update')->name('admin.weboption.update')->middleware('permission:config.weboption.edit');
        //删除
