...
<div class="main oh">
    <style>
        ...
        .vip-type a {
            ...
            line-height: 38px;
            color: #fff;
            background: url('//ss.51miz.com/V3/images/VIP_btn.png') 0 -78px no-repeat;
        ...
        .download-right-arr {
            width: 16px;
            height: 12px;
            background: url('//ss.51miz.com/V3/images/VIP_btn.png') -183px -13px no-repeat;
            background-size: 249px 316px;
            top: 23px;
            left: 96px;
            z-index: 9;
    ...
    <style>
        .homenav {
            ...
            background: linear-gradient(90deg, #8d54e9 0%, #3f6fe0 100%);
            margin-bottom: 90px;
        }
        ...
        .myinfo .on {
            border-bottom: 2px solid #7371ef;
        + height: 58 px;
        }
    ...
    <div class="main-content oh">
        ...
        <div class="myvip">
            ...
            @if(request()->get('type') != 'reg')
                ...
                <link rel="stylesheet"
                      href="https://www.uishe.cn/wp-content/themes/cx-udy/css/font-awesome.min.css?ver=1.2">
                <style>
                    .other_login {
            ...
            @if(request()->get('type') == 'reg')
                <form method="post" action="{{ url('/reg') }}" onsubmit="return checkreg(this)">
                    <div class="login-form-item">
                        <label class="login-form-label">用户名:</label>
                        <input type="text" required name="username" id="username" class="login-form-input"
                               value="{{ old('username') }}">
                        <span id="username_span" style="color: red;">请输入6-16位用户名</span>
                    </div>
                    <div class="login-form-item">
                        <label class="login-form-label">邮箱:</label>
                        <input type="text" required name="email" id="email" class="login-form-input"
                               value="{{ old('email') }}">
                        <span id="email_span" style="color: red;">请输入正确邮箱</span>
                    </div>
                    <div class="login-form-item">
                        <label class="login-form-label">密码:</label>
                        <input type="password" required name="password" id="password" class="login-form-input"
                               value="{{ old('password') }}">
                    ...
                    <div class="login-form-item">
                        ...
                        <input type="password" required name="password_confirmation" id="password_confirmation"
                               class="login-form-input" value="{{ old('password_confirmation') }}">
