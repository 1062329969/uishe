 ...
 * Generated for Laravel 5.6.39 on 2020-01-20 08:01:10.
 *
...
namespace Illuminate\Support\Facades { 
    ...
    class Response {
         ...
         * @static 
         */ 
        public static function success($msg = 'SUCCESS', $token = '')
        {
                        return \Illuminate\Routing\ResponseFactory::success($msg, $token);
        }
         ...
         * @static 
         */ 
        public static function error($code = 500, $msg = 'error', $token = '')
        {
                        return \Illuminate\Routing\ResponseFactory::error($code, $msg, $token);
        }
         ...
         * @static 
         */ 
        public static function model($model, $token = '')
        {
                        return \Illuminate\Routing\ResponseFactory::model($model, $token);
        }
         ...
         * @static 
         */ 
        public static function array($arr, $token = '')
        {
                        return \Illuminate\Routing\ResponseFactory::array($arr, $token);
        }
         ...
         * @static 
         */ 
        public static function string($value, $token = '')
        {
                        return \Illuminate\Routing\ResponseFactory::string($value, $token);
        }
         ...
         * @static 
         */ 
        public static function json_unicode($arr)
        {
                        return \Illuminate\Routing\ResponseFactory::json_unicode($arr);
        }
...
namespace ShaoZeMing\LaravelTranslate\Facade { 
    ...
    class Translate {
        ...
        {
                        /** @var \ShaoZeMing\Translate\TranslateService $instance */
         ...
         * @static 
         */ 
        public static function setFromAndTo($from, $to)
        {
                        /** @var \ShaoZeMing\Translate\TranslateService $instance */
                        return $instance->setFromAndTo($from, $to);
        }
         ...
         * @static 
         */ 
        public static function setHttpOption($options = [])
        {
                        /** @var \ShaoZeMing\Translate\TranslateService $instance */
                        return $instance->setHttpOption($options);
        }
         ...
         * @static 
         */ 
        public static function translate($string, $source = false)
        {
                        /** @var \ShaoZeMing\Translate\TranslateService $instance */
                        return $instance->translate($string, $source);
        }
...
namespace Yansongda\LaravelPay\Facades { 
    ...
    class Pay {
         ...
         * @throws InvalidSignException
         * @throws InvalidArgumentException
         * @return \Yansongda\Pay\Gateways\Collection|null 
         * @static 
         */ 
...
namespace  { 
    ...
    class Translate extends \ShaoZeMing\LaravelTranslate\Facade\Translate {}
